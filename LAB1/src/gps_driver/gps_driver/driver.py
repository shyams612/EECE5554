...
class GPSDriver:
    ...
    def parse_line(self, line: str):
        """
        Parse a GPGGA NMEA string and return GPSFix.
        Returns None if line is invalid or not GPGGA.
        """
...
# -----------------------
def main():
    parser = argparse.ArgumentParser(description="GPS GPGGA → UTM ROS2 publisher")
    parser.add_argument(
        "-p", "--port",  # Changed from -f/--file
        required=True,
        help="Path to GPS device or PTY (e.g. /dev/ttyUSB0, /dev/pts/2)"
    )
